...
/**
 * Staff Login Page
 * For: Sangguniang Barangay, Barangay Secretary, Barangay Treasurer, Punong Barangay
 */
session_start();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && !isLoginLockedOut($clientIP)) {
    ...
    if (empty($email) || empty($password)) {
        ...
        $result = validateLoginWith2FA($email, $password, $totp_code, 'staff');
...
<head>
    ...
    <title>Staff Login - Barangay e-Services</title>
    <link rel="stylesheet" href="../assets/css/style.css">
</head>
<body>
    <div class="auth-container">
        <div class="auth-box">
            <h2><?php echo $show_2fa_form ? 'Two-Factor Authentication' : 'Staff Portal Login'; ?></h2>
            <?php if (!$show_2fa_form): ?><p class="text-muted">For Authorized Personnel Only</p><?php endif; ?>

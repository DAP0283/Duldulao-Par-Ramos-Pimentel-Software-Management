        ...
        <aside class="sidebar">
            ...
            <nav class="sidebar-nav">
                <ul>
                    ...
                    <li><a href="punong-barangay/messages.php" class="active">Messages</a></li>
                    ...
                    <li><a href="treasurer/applications.php">Applications</a></li>
                    <li><a href="treasurer/messages.php" class="active">Messages</a></li>
                    <?php elseif ($staff_role === 'Barangay Secretary'): ?>
                    <li><a href="secretary/dashboard.php">Dashboard</a></li>
                    <li><a href="secretary/applications.php">Applications</a></li>
                    <li><a href="secretary/clients.php">Clients</a></li>
                    <li><a href="secretary/messages.php" class="active">Messages</a></li>
                    <?php else: ?>
